...
export default function Air() {
  return (
    <section className="w-full bg-white lg:pt-20 pt-8 pb-6 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-[100px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-10 items-start">
          ...
          <div className="max-w-xl">
            ...
            {/* CTA */}
            <button className="lg:mt-8 mt-3 rounded-2xl bg-[#4BAF47] px-6 sm:px-8 md:px-10 py-3 sm:py-4 text-[16px] font-extrabold text-[#ffffff] hover:bg-[#43a047] transition">
              Contact us now
            </button>
          </div>
          ...
          <div className="relative lg:block hidden">
            {/* Green strip */}
            <div className="absolute top-0 left-0 h-[150px] w-screen bg-[#4BAF47] rounded-l-xl" />

            {/* Text inside strip */}
            <div className="relative h-[72px] flex items-center pl-4 sm:pl-6 md:pl-8 lg:pl-12 max-w-[600px] mt-9 text-justify">
